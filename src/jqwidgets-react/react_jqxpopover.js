...
export default class JqxPopover extends React.Component {
    ...
    manageAttributes() {
        let properties = ['arrowOffsetValue', 'animationOpenDelay', 'animationCloseDelay', 'autoClose', 'animationType', 'height', 'initContent', 'isModal', 'offset', 'position', 'rtl', 'selector', 'showArrow', 'showCloseButton', 'width', 'title', 'theme','enableBrowserBoundsDetection'];
        let options = {};
