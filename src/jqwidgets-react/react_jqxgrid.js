...
export default class JqxGrid extends React.Component {
    ...
    /* Added By: Pritam on 2018-05-30 to show Clear All and Reset Grid buttons */
    customfilterbuttons(arg) {
        if (arg !== undefined) {
            JQXLite(this.componentSelector).jqxGrid('customfilterbuttons', arg);
        } else {
            return JQXLite(this.componentSelector).jqxGrid('customfilterbuttons');
        }
    };
    /* End of Added by Pritam */
    /* Added by Pritam for story NEWC3-206 on 05-April-2018 */
    forcefullyscroll(arg) {
        if (arg !== undefined) {
            JQXLite(this.componentSelector).jqxGrid('forcefullyscroll', arg);
        } else {
            return JQXLite(this.componentSelector).jqxGrid('forcefullyscroll');
        }
    };
    /* End of Added by Pritam for story NEWC3-206 */
    /** Grid header issue for pinned column occurs on maximize and minimise. Story: NEWC3-235  Added By: Pritam Kolekar Added on: 2018-04-20 */
    applywindowresize(arg) {
        if (arg !== undefined) {
            JQXLite(this.componentSelector).jqxGrid('applywindowresize', arg);
        } else {
            return JQXLite(this.componentSelector).jqxGrid('applywindowresize');
        }
    };
    /** End of Grid header issue for pinned column occurs on maximize and minimise. Story: NEWC3-235  Added By: Pritam Kolekar Added on: 2018-04-20 */
    /** Added By Hiren on 30-Apr-2108 for JIRA NEWC3-238 **/
    localdatafilter(arg) {
        if (arg !== undefined) {
            JQXLite(this.componentSelector).jqxGrid('localdatafilter', arg);
        } else {
            return JQXLite(this.componentSelector).jqxGrid('localdatafilter');
        }
    };
    /** End of Added By Hiren on 30-Apr-2108 for JIRA NEWC3-238 **/
    /** Added By Harshal on 31-May-2018 for JIRA NEWC3-343 **/
    enablecolumnsvirtualization(arg) {
        if (arg !== undefined) {
            JQXLite(this.componentSelector).jqxGrid('enablecolumnsvirtualization', arg);
        } else {
            return JQXLite(this.componentSelector).jqxGrid('enablecolumnsvirtualization');
        }
    };
    /** End of Added By Harshal on 31-May-2018 for JIRA NEWC3-343 **/
    ...
    /** Pooja Iyer | 10 th May 2018 | NEWIMS-307 - hides the default group by column from the menu */
    groupbyitemmenudisplay(arg) {
        if (arg !== undefined) {
            JQXLite(this.componentSelector).jqxGrid('groupbyitemmenudisplay', arg)
        } else {
            return JQXLite(this.componentSelector).jqxGrid('groupbyitemmenudisplay');
        }
    };
    render() {
